  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(PostBlock, [{
    ...
    value: function render() {
      ...
      return __jsx(react_apollo__WEBPACK_IMPORTED_MODULE_11__["Mutation"], {
        ...
        if (errorUpdate) {
          console.log('query Post errorUpdate: ', errorUpdate); //return (<Message negative>              <Message.Header>Ошибка!</Message.Header>              <p>{errorUpdate}</p>            </Message>);
        }
...
//# sourceMappingURL=post.js.a13e0d7c0ccda5142e43.hot-update.js.map