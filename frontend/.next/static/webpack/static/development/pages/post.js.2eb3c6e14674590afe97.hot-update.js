  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(PostBlock, [{
    ...
    value: function render() {
      ...
      return __jsx(react_apollo__WEBPACK_IMPORTED_MODULE_11__["Mutation"], {
        ...
        var loadingUpdate = _ref3.loading,
            errorUpdate = _ref3.error;

        if (errorUpdate) {
          console.log('query Post errorUpdate: ', errorUpdate);
          console.log('query Post errorUpdate: ', errorUpdate.message.replace('GraphQL error: ', '')); //return (<Message negative>              <Message.Header>Ошибка!</Message.Header>              <p>{errorUpdate}</p>            </Message>);
        }
...
//# sourceMappingURL=post.js.2eb3c6e14674590afe97.hot-update.js.map