...
const DynamicComponentWithNoSSR = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ../components/Item */ "./components/Item.js")), {
  ssr: false,
  loadableGenerated: {
    webpack: () => [/*require.resolve*/(/*! ../components/Item */ "./components/Item.js")],
  ...
  render() {
    ...
    return __jsx(Center, {
      ...
      return __jsx(ItemsList, {
        ...
        __self: this
      }, data.posts.map(post => __jsx(DynamicComponentWithNoSSR, {
        item: post,
        key: post.id,
        __source: {
          fileName: _jsxFileName,
